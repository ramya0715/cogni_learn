import { c as createLucideIcon, f as clsx, R as React, M as getDefaultExportFromCjs, r as reactExports, b as useNavigate, N as useGetAnalytics, O as useGetRecommendations, j as jsxRuntimeExports, H as ue, h as CognitiveLoadBadge, k as ChevronRight, e as cn, B as BookOpen } from "./index-B3pXppQ4.js";
...
import { f as filterProps, q as polarToCartesian, _ as _baseExtremum, r as _baseGt, s as _baseIteratee, t as _baseLt, g as isFunction, v as Text, L as Layer, w as getTickClassName, x as adaptEventsOfChild, y as Label, D as Dot, A as Animate, a as interpolateNumber, d as isEqual, e as LabelList, G as Global, j as getValueByDataKey, z as last, b as isNil, E as findAllByType, F as ErrorBar, C as Curve, h as hasClipDot, u as uniqueId, k as getCateCoordinateOfLine, l as generateCategoricalChart, X as XAxis, Y as YAxis, n as formatAxisMap, H as formatAxisMap$1, R as ResponsiveContainer, o as CartesianGrid, T as Tooltip, I as ReferenceLine, B as BarChart, p as Bar, J as Legend } from "./BarChart-BWdEwPaI.js";
...
var PolarAngles = function PolarAngles2(props) {
  ...
  var polarAnglesProps = _objectSpread$4({
    stroke: "#ccc"
  ...
  return /* @__PURE__ */ React.createElement("g", {
    ...
    return /* @__PURE__ */ React.createElement("line", _extends$4({}, polarAnglesProps, {
...
var ConcentricCircle = function ConcentricCircle2(props) {
  ...
  var concentricCircleProps = _objectSpread$4(_objectSpread$4({
    stroke: "#ccc"
  }, filterProps(props, false)), {}, {
    fill: "none"
  });
  return /* @__PURE__ */ React.createElement("circle", _extends$4({}, concentricCircleProps, {
...
var ConcentricPolygon = function ConcentricPolygon2(props) {
  ...
  var concentricPolygonProps = _objectSpread$4(_objectSpread$4({
    stroke: "#ccc"
  }, filterProps(props, false)), {}, {
    fill: "none"
  });
  return /* @__PURE__ */ React.createElement("path", _extends$4({}, concentricPolygonProps, {
...
var ConcentricPath = function ConcentricPath2(props) {
  ...
  return /* @__PURE__ */ React.createElement("g", {
    ...
    var key = i;
    if (gridType === "circle") return /* @__PURE__ */ React.createElement(ConcentricCircle, _extends$4({
      key
    }, props, {
      radius: entry,
      index: i
    }));
    return /* @__PURE__ */ React.createElement(ConcentricPolygon, _extends$4({
      key
    }, props, {
      radius: entry,
      index: i
...
var PolarGrid = function PolarGrid2(_ref) {
  ...
  return /* @__PURE__ */ React.createElement("g", {
  ...
  }, /* @__PURE__ */ React.createElement(PolarAngles, _extends$4({
    cx,
    cy,
    innerRadius,
    outerRadius,
    gridType,
    radialLines
  }, props)), /* @__PURE__ */ React.createElement(ConcentricPath, _extends$4({
    cx,
    cy,
    innerRadius,
    outerRadius,
  ...
  return _createClass$1(Radar2, [{
    ...
    value: function renderPolygonStatically(points) {
      ...
      if (/* @__PURE__ */ React.isValidElement(shape)) {
        ...
        radar = /* @__PURE__ */ React.createElement(Polygon, _extends$1({}, filterProps(this.props, true), {
    ...
    value: function renderDotItem(option, props) {
      ...
      if (/* @__PURE__ */ React.isValidElement(option)) {
        ...
        dotItem = /* @__PURE__ */ React.createElement(Dot, _extends$1({}, dotProps, {
          key,
...
function getCognitiveCategory(score) {
...
function ChartTooltip({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card px-3 py-2 text-sm shadow-xl min-w-[120px]", children: [
    label && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-1 text-xs", children: label }),
    payload.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-medium", style: { color: p.color }, children: [
      p.name,
      ":",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: typeof p.value === "number" ? p.value.toFixed(1) : p.value })
    ] }, p.name))
  ] });
}
function CogLoadTooltip({
  ...
  const catColor = cat === "Low" ? "#4ade80" : cat === "Moderate" ? "#facc15" : "#f97316";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card px-3 py-2 text-sm shadow-xl", children: [
    label && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-1 text-xs", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-medium", style: { color: catColor }, children: [
      "Score: ",
      score.toFixed(0)
    ] }),
...
function SummaryCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-5 flex flex-col gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-7 w-24 mt-1" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-display font-bold text-foreground mt-0.5", children: value }),
      sub && !loading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-0.5", children: sub })
    ] })
  ] });
}
function ChartSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "glass-card p-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground mb-4 text-base", children: title }),
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-56 w-full rounded-lg" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-56", children })
  ] });
}
function Analytics() {
  ...
  const cogLoadData = reactExports.useMemo(() => {
    var _a;
    if (!((_a = analytics == null ? void 0 : analytics.cognitiveLoadTrend) == null ? void 0 : _a.length)) return [];
    return analytics.cognitiveLoadTrend.slice().sort((a, b) => Number(a.timestamp - b.timestamp)).map((e) => ({
      date: formatTimestamp(e.timestamp),
      score: Number.parseFloat(e.loadScore.toFixed(1)),
      color: e.loadScore < 35 ? "#4ade80" : e.loadScore < 65 ? "#facc15" : "#f97316"
    }));
  }, [analytics]);
  const weeklyData = reactExports.useMemo(() => {
    const arr = (analytics == null ? void 0 : analytics.weeklyStudyDays) ?? [];
    return DAY_LABELS.map((day, i) => ({
      day,
      sessions: Number(arr[i] ?? 0n)
    }));
  }, [analytics]);
  const subjectData = reactExports.useMemo(() => {
    const map = new Map((analytics == null ? void 0 : analytics.subjectAccuracy) ?? []);
  ...
  const accuracyTrendData = reactExports.useMemo(() => {
    var _a;
    if (!((_a = analytics == null ? void 0 : analytics.cognitiveLoadTrend) == null ? void 0 : _a.length)) return [];
    const trend = analytics.cognitiveLoadTrend.slice().sort((a, b) => Number(a.timestamp - b.timestamp));
  ...
  const weakTopics = reactExports.useMemo(() => {
    const map = new Map((analytics == null ? void 0 : analytics.subjectAccuracy) ?? []);
    return SUBJECTS.map((s) => {
      var _a;
      return {
        ...
        topic: s,
        accuracy: Number.parseFloat(((map.get(s) ?? 0) * 100).toFixed(1)),
        sessions: Number((analytics == null ? void 0 : analytics.totalQuizzes) ?? 0n),
        lastAttempted: ((_a = analytics == null ? void 0 : analytics.cognitiveLoadTrend) == null ? void 0 : _a.length) ? formatTimestamp(
          analytics.cognitiveLoadTrend[analytics.cognitiveLoadTrend.length - 1].timestamp
        ) : "—"
      };
    }).sort((a, b) => a.accuracy - b.accuracy);
  }, [analytics]);
  const overallAccuracy = analytics ? Number.parseFloat((analytics.overallAccuracy * 100).toFixed(1)) : 0;
  const totalSessions = analytics ? Number(analytics.totalQuizzes) : 0;
  const avgLoadScore = reactExports.useMemo(() => {
    const trend = analytics == null ? void 0 : analytics.cognitiveLoadTrend;
    if (!(trend == null ? void 0 : trend.length)) return 0;
    return trend.reduce((s, e) => s + e.loadScore, 0) / trend.length;
  }, [analytics]);
  const consistencyScore = analytics ? (analytics.weeklyStudyDays ?? []).filter((d) => Number(d) > 0).length / 7 : 0;
  const efficiencyScore = analytics ? Math.min(
    100,
    Number.parseFloat(
      (analytics.overallAccuracy * consistencyScore * 100).toFixed(0)
    )
  ) : 0;
  function recBadgeVariant(type) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 pb-10", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h1",
          {
            ...
            children: "Your Learning Analytics"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-0.5", children: "Track performance, cognitive load, and progress over time" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
        [7, 14, 30].map((d) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            type: "button",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            SummaryCard,
            {
              ...
              accentClass: overallAccuracy >= 70 ? "bg-[oklch(0.72_0.18_145/0.15)] text-[oklch(0.72_0.18_145)]" : overallAccuracy >= 50 ? "bg-[oklch(0.75_0.16_85/0.15)] text-[oklch(0.75_0.16_85)]" : "bg-[oklch(0.65_0.22_25/0.15)] text-[oklch(0.65_0.22_25)]",
              loading: isLoading
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            SummaryCard,
            {
              ...
              value: !isLoading && hasData ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                CognitiveLoadBadge,
                {
    ...
    !isLoading && !hasData && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "glass-card p-10 flex flex-col items-center justify-center gap-4 text-center",
        "data-ocid": "analytics.empty_state",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-2xl bg-muted flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartNoAxesColumn, { size: 28, className: "text-muted-foreground" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground text-lg", children: "No Analytics Yet" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: "Complete a few quiz sessions to start seeing your learning analytics." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: "Take First Quiz"
            }
          )
        ]
      }
    ),
    (isLoading || hasData) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChartSection, { title: "Cognitive Load Over Time", loading: isLoading, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        LineChart,
        {
          data: cogLoadData,
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { content: /* @__PURE__ */ jsxRuntimeExports.jsx(CogLoadTooltip, {}) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ReferenceLine,
              {
                y: 35,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "cogLoadGrad", x1: "0", y1: "0", x2: "0", y2: "1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "#4ade80" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "50%", stopColor: "#facc15" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "#f97316" })
            ] }) })
          ]
        }
      ) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChartSection, { title: "Weekly Study Activity", loading: isLoading, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        BarChart,
        {
          data: weeklyData,
          margin: { top: 4, right: 12, left: -20, bottom: 0 },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChartSection, { title: "Accuracy by Subject", loading: isLoading, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        RadarChart,
        {
          data: subjectData,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Tooltip,
              {
                content: ({ active, payload }) => {
                  ...
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card px-3 py-2 text-sm shadow-xl", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-medium", children: p.fullName }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { color: accuracyColor(p.accuracy) }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChartSection, { title: "Accuracy Trend", loading: isLoading, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        LineChart,
        {
          ...
          children: [
            ...
            SUBJECTS.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              Line,
              {
                type: "monotone",
                dataKey: s,
                ...
                strokeWidth: 1.5,
                dot: false,
                strokeDasharray: i % 2 === 1 ? "4 2" : void 0
              },
              s
            ))
          ]
    ...
    (isLoading || hasData) && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-display font-semibold text-foreground text-base flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { size: 16, className: "text-[oklch(0.65_0.22_25)]" }),
            "Topics Needing Attention"
          ] }) }),
          isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [0, 1, 2, 3, 4].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-12 w-full rounded-lg" }, i)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left pb-2 text-xs text-muted-foreground font-medium pr-4", children: "Subject" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left pb-2 text-xs text-muted-foreground font-medium pr-4", children: "Topic" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right pb-2 text-xs text-muted-foreground font-medium pr-4", children: "Accuracy" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right pb-2 text-xs text-muted-foreground font-medium pr-4", children: "Sessions" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left pb-2 text-xs text-muted-foreground font-medium pr-4", children: "Last Attempted" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "pb-2" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border/50", children: weakTopics.map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "tr",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 pl-2 pr-4 font-medium text-foreground", children: row.subject }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 pr-4 text-muted-foreground", children: row.topic }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "td",
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 pr-4 text-right text-muted-foreground", children: row.sessions }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 pr-4 text-muted-foreground", children: row.lastAttempted }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Button,
                    {
                      type: "button",
                      size: "sm",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "analytics.recommendations_section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-display font-semibold text-foreground text-base mb-4 flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Lightbulb, { size: 16, className: "text-primary" }),
        "Personalized Recommendations"
      ] }),
      recommendationsQuery.isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-4", children: [0, 1, 2].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-32 w-full rounded-xl" }, i)) }) : recommendations.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Complete quizzes to receive personalized recommendations." })
          ]
        }
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-4", children: recommendations.map((rec, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-lg bg-primary/15 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Lightbulb, { size: 16, className: "text-primary" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  variant: recBadgeVariant(rec.recType),
                  className: "text-xs",
                  children: rec.recType.replace(/([A-Z])/g, " $1").trim()
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-sm truncate", children: rec.targetSubject }),
              rec.targetTopic && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground truncate", children: rec.targetTopic }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1 line-clamp-2", children: rec.reason })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
